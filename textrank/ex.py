...
#크롤링할 url 주소 입력
url="https://blockdmask.tistory.com/432"
...
print(raw_input_ids) #ok -1차원 리스트

input_ids = [tokenizer.bos_token_id] + raw_input_ids + [tokenizer.eos_token_id] + [0]
print(input_ids) #ok -1차원 리스트


summary_ids = model.generate( torch.tensor([input_ids]) )
print(type(summary_ids)) #tensor( [[ ... ]] )
